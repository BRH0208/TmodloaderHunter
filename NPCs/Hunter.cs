...
using Hunter.Items;
using Hunter.UI;
using Hunter.Projectiles;
using System;
using System.Collections;
using Terraria.ModLoader;
using static Terraria.ModLoader.ModContent;
namespace Hunter.NPCs
{
	[AutoloadHead]
	public class HunterNPC : ModNPC{
		public override string Texture => "Hunter/NPCs/Hunter";
		...
		*/
		...
		public override void OnChatButtonClicked(bool firstButton, ref bool shop) {
			...
			if (firstButton) {
				...
				Main.npcChatText = "";
				GetInstance<Hunter>().HunterUserInterface.SetState(new UI.HunterUI());
